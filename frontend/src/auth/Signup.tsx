        ...
        <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(34,211,238,0.18),_transparent_30%),linear-gradient(180deg,#020817,#111827_35%,#0f172a)] px-4 py-10 text-slate-100">
            <div className="w-full max-w-md rounded-[30px] border border-white/10 bg-white/5 p-6 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl">
                <div className="mb-6 text-center">
                    ...
                    <h2 className="mt-3 text-3xl font-bold text-white">Start planning</h2>
                </div>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="pt-2">
                        <button className="w-full rounded-full bg-gradient-to-r from-cyan-400 to-violet-500 px-5 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-cyan-500/20 transition hover:scale-[1.02]" type="submit">Create account</button>
                    </div>
                </form>
                <p className="mt-6 text-center text-sm text-slate-300">
                    Already have an account? <a href="/login" className="font-semibold text-cyan-300">Sign in</a>
                </p>
            </div>
        </div>
    );
